  ...
  setUser({ ...user, email: trimmedEmail });
    ...
    useEffect(() => {
        GoogleSignin.configure({
            webClientId: '635423054737-jo7sr1qebvcseha7hq24nutg5j62c52i.apps.googleusercontent.com', // Replace with your web client ID from Google Developer Console
            offlineAccess: true,
    ...
    const signIn = async () => {
        try {
            ...
            if (error.code === statusCodes.SIGN_IN_CANCELLED) {
                ...
                Alert.alert('Play services not available or outdated. Please update and try again.');
            } else {
